...
Order dataset. First waves, then id.
...
```{r}
model_1 <- lmer(life_sat ~ (1 | id) + soc_med_fb + soc_med_ig + soc_med_wa + soc_med_yt + soc_med_tw,
                data = d_long)
summary(model_1)
```
...
```{r}
model_2 <- lmer(life_sat ~ (1 | id) + (1 | wave) + soc_med_read_b + soc_med_read_w + soc_med_like_share_b + soc_med_like_share_w + soc_med_post_b + soc_med_post_w + soc_med_fb_b + soc_med_fb_w + soc_med_ig_b + soc_med_ig_w + soc_med_wa_b + soc_med_wa_w + soc_med_yt_b + soc_med_yt_w + soc_med_tw_b + soc_med_tw_w,
                data = d_long)
summary(model_2)
```
