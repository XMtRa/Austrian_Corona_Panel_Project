...
Explanation: The wording of the hypotheses was changed slightly. Instead of "trivial", it not states "very small". The reason was that trivial contains a normative element (irrelevant). Instead, I now state "very small", which seems more objective. Some might consider very small effects trivial, others not.

In addition, I link to the control variables explicated below.
