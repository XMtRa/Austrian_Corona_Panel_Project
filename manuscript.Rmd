...
<!-- It is therefore often asked whether social media can become addictive, with users sometimes expressing this fear themselves. -->
<!-- END -->
...
<!-- Social media can be a valuable _educational tool_, with various organizations and experts sharing informative content about COVID-19 [@worldhealthorganizationCoronavirusDiseaseCOVID192023].  -->
...
<!-- Social media algorithms are designed to show users content that aligns with their interests and beliefs, potentially contributing to _echo chambers_ [@cinelliEchoChamberEffect2021].  -->
...
When using longitudinal designs to analyze causality, it is important to (a) focus on within-person effects [@hamakerWhyResearchersShould2014]; to (b) control for confounders [@rohrerTheseAreNot2023]; and to (c) test a plausible interval between measures [@dormannOptimalTimeLags2015].
...
Between-person comparisons from longitudinal data cannot provide such insights [@hamakerWhyResearchersShould2014].
...
Because we are adopting a within-person perspective, we need to implement _time-varying_ confounders [@rohrerTheseAreNot2023]. 
...
This is aligned with prior findings which showed that social media use is associated with increased negative affect but not with life satisfaction [@meierComputermediatedCommunicationSocial2020a].
...
Communication on both channels is often found to be negative and impolite [e.g., @muellerTwitterMadeMe2022].
...
Finally, recent empirical studies and meta-analyses reported rather small negative effects, too [@meierComputermediatedCommunicationSocial2020a], 
<!-- Several studies found that the effects of various types of social media use on well-being are small, often too small to matter [@meierComputermediatedCommunicationSocial2020a],  -->
...
However, for social media use objective measures are preferable, as people often cannot reliably estimate their use [@scharkowAccuracySelfreportedInternet2016].
