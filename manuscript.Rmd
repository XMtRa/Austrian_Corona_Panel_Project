...
To this end, I analyzed a large-scale **stand-alone** panel study from the Austrian Corona Panel Project [@kittelAustrianCoronaPanel2020]. 
...
**Two underlying theories guided the selection of variables for my analysis, the two-continua model of mental health [@greenspoonIntegrationSubjectiveWellbeing2001] and the hierarchical taxonomy of computer-mediated communication [@meierComputermediatedCommunicationSocial2020a].**
...
**First studies suggest that Instagram use was indeed more beneficial for well-being than Facebook use [@masciantonioDonPutAll2021].**
