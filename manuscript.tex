...
Scharkow, M. (2016). The accuracy of self-reported {Internet} use\textemdash{{A}} validation study using client log data. \emph{Communication Methods and Measures}, \emph{10}(1), 13--27.
