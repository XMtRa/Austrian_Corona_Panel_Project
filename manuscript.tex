...
\hypersetup{
  ...
  pdfauthor={Name blinded for review1},
  pdflang={en-EN},
...
Defining what constitutes active and what passive use is not always clear, and different understandings are currently discussed Meier \& Reinecke (2020).
...
Only very specific events such as unemployment, disability, or death can cause long-term decreases in well-being (Lucas, 2007).
...
According to the different susceptibility of media effects model (Valkenburg \& Peter, 2013), the effects of media use differ across individuals.
...
Also when focusing on individual users, social media have both positive and negative effects on well-being (Büchi, 2021).
...
The second major theory is mood management theory (Zillmann, 1988).
...
Using experience sampling of well-being and logs of social media use, a study with 82 participants from Italy found that after episodes of social media use, levels of positive affect increased for a short time (Marciano, Driver, Schulz, \& Camerini, 2022).

Precisely because social media have so many positive consequences, one can ask if this is the main problem.
...
In addition, the general idea of labeling excessive social and new media use as addiction was criticized, arguing that social and new media represent new regular behaviors that should not be pathologized (Galer, 2018; van Rooij et al., 2018).
...
It is most likely that moderate social media use is not detrimental (Orben, 2020).
...
Several individual studies employing advanced methods found smalls relations between social media use and well-being (Keresteš \& Štulhofer, 2020; Orben, Dienlin, \& Przybylski, 2019; Przybylski, Nguyen, Law, \& Weinstein, 2021; Schemer, Masur, Geiß, Müller, \& Schäfer, 2021).
...
Although there is substantial variation of media effects for individual users, the average effects reported in the literature are often small (Valkenburg \& Peter, 2013).
...
For more information on the analyses, a complete documentation of the models and results, see \href{https://XMtRA.github.io/Austrian_Corona_Panel_Project}{companion website}.
...
COVID-19 related social media use focused on communication types was measured with the three dimensions of (a) reading, (b) liking and sharing, and (c) posting from Wagner et al. (2018), adapted for the context of this study.
...
Bradley, A., \& Howard, A. (2021). Stress, mood, and smartphone use in {University} students: {A} 12-week longitudinal study. \url{https://doi.org/10.31219/osf.io/frvpb}

\leavevmode\vadjust pre{\hypertarget{ref-brownEasyHappinessPie2019}{}}%
...
Dörnemann, A., Boenisch, N., Schommer, L., Winkelhorst, L., \& Wingen, T. (2021). How do good and bad news impact mood during the {Covid-19} pandemic? {The} role of similarity. \url{https://doi.org/10.31219/osf.io/sy2kd}
...
European Social Survey. (2021). {ESS9} edition 3.1 - 2018 {Documentation Report}. Retrieved from \url{https://www.europeansocialsurvey.org/docs/round9/survey/ESS9_data_documentation_report_e03_1.pdf}
...
Galer, S. S. (2018, January 19). How much is {`too much time'} on social media? Retrieved April 4, 2022, from \url{https://www.bbc.com/future/article/20180118-how-much-is-too-much-time-on-social-media}
...
Kittel, B., Kritzinger, S., Boomgaarden, H., Prainsack, B., Eberl, J.-M., Kalleitner, F., \ldots{} Schlogl, L. (2020). \emph{Austrian {Corona Panel Project} ({SUF} edition)} {[}Data set{]}. {AUSSDA}. \url{https://doi.org/10.11587/28KQNS}
...
Klein, J. (2021, March 3). The darkly soothing compulsion of 'doomscrolling'. Retrieved November 1, 2021, from \url{https://www.bbc.com/worklife/article/20210226-the-darkly-soothing-compulsion-of-doomscrolling}
...
McElreath, R. (2021, January 28). Yesterday in class, ... {[}Tweet{]}. Retrieved November 5, 2021, from \url{https://twitter.com/rlmcelreath/status/1354786005996482563}
...
Sandstrom, G., Buchanan, K., Aknin, L., \& Lotun, S. (2021, October 22). Doomscrolling {COVID} news takes an emotional toll -- here's how to make your social media a happier place. Retrieved November 3, 2021, from \url{http://theconversation.com/doomscrolling-covid-news-takes-an-emotional-toll-heres-how-to-make-your-social-media-a-happier-place-170342}
...
Sheldon, K. M., \& Lucas, R. E. (2014). \emph{Stability of happiness: Theories and evidence on whether happiness can change}. Retrieved from \url{http://site.ebrary.com/id/10891875}
...
Statista. (2021, May 21). Average daily time spent on social networks by users in the {United States} from 2018 to 2022. Retrieved from \url{https://www.statista.com/statistics/1018324/us-users-daily-social-media-minutes/}
...
Wagner, M., Aichholzer, J., Eberl, J.-M., Meyer, T. M., Berk, N., Büttner, N., \ldots{} Müller, W. C. (2018). \emph{{AUTNES Online Panel Study} 2017 ({SUF} edition)} {[}Data set{]}. {AUSSDA}. \url{https://doi.org/10.11587/I7QIYJ}
...
\begin{figure}
\includegraphics[width=\textwidth]{figures/fig_results_channels} \caption{The effects of using various social media applications on three indicators of well-being. The black estimates show the effects controlled for a large number of covariates (see text; preregistered); the grey estimates are without control variables (exploratory). The SESOI was b = |0.30| for life satisfaction and b = |0.15| for affect. Hence, all of the reported effects are not considered meaningful.}\label{fig:res-channels}
\end{figure}
